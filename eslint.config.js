          ...
          patterns: [
            {
              group: ['**/tailwindcss/**'],
              message:
                'Use CSS variables instead of direct Tailwind color classes. Use bg-primary instead of bg-blue-500, text-secondary instead of text-gray-600, etc.'
            }
          ]
        }
      ]
    ...
    rules: {
      'no-restricted-syntax': [
        'error',
        {
          ...
          message:
            '"use client" is not allowed in page.tsx files. Move logic to a client.tsx file as per /utils/supabase/README.md'
        }
      ]
    }
  },
